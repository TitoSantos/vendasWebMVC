    ...
    public partial class OutrasEntidades : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistrosdeVendas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegistrosdeVendas_Vendedor_VendedorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrosdeVendas_VendedorId",
                table: "RegistrosdeVendas",
                column: "VendedorId");
